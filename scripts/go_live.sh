...
echo "  Open the app:      ./scripts/open_hrp.sh                 (web app + API)"
...
echo "  strategy is a human gate by design (you are the CIO). Approve recommendations"
echo "  in the app; recommendations then flow from deployed models."
